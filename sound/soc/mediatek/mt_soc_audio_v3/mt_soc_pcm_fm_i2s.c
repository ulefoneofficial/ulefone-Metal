...
static int mtk_pcm_fm_i2s_prepare(struct snd_pcm_substream *substream)
{
	...
	if (mPrepareDone == false) {
		...
		#if defined(LYCONFIG_KERNEL_SMARTPA_TFA98XX)
        	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I10, Soc_Aud_InterConnectionOutput_O00);       // add for smartpa connect I2S3
        	SetConnection(Soc_Aud_InterCon_Connection, Soc_Aud_InterConnectionInput_I11, Soc_Aud_InterConnectionOutput_O01);       // add for smartpa connect I2S3
		#endif
