...
ifneq ($(strip $(TARGET_NO_KERNEL)),true)
  ...
  ifeq ($(wildcard $(TARGET_PREBUILT_KERNEL)),)
    ...
    KERNEL_MAKE_OPTION := O=$(KERNEL_OUT) ARCH=$(TARGET_ARCH) MTK_TARGET_PROJECT=$(MTK_TARGET_PROJECT) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) ROOTDIR=$(KERNEL_ROOT_DIR) $(if $(strip $(SHOW_COMMANDS)),V=1)
