...
{
	BATTERY_VOLT_03_725000_V,   BATTERY_VOLT_03_750000_V,	BATTERY_VOLT_03_775000_V,   BATTERY_VOLT_03_800000_V,
	BATTERY_VOLT_03_825000_V,   BATTERY_VOLT_03_850000_V,	BATTERY_VOLT_03_875000_V,   BATTERY_VOLT_03_900000_V,
	BATTERY_VOLT_03_925000_V,   BATTERY_VOLT_03_950000_V,	BATTERY_VOLT_03_975000_V,   BATTERY_VOLT_04_000000_V,	
	BATTERY_VOLT_04_025000_V,   BATTERY_VOLT_04_050000_V,	BATTERY_VOLT_04_075000_V,   BATTERY_VOLT_04_100000_V,
	BATTERY_VOLT_04_125000_V,   BATTERY_VOLT_04_150000_V,	BATTERY_VOLT_04_175000_V,   BATTERY_VOLT_04_200000_V,
	BATTERY_VOLT_04_225000_V,   BATTERY_VOLT_04_250000_V,	BATTERY_VOLT_04_275000_V,   BATTERY_VOLT_04_300000_V,	
...
{
	CHARGE_CURRENT_100_00_MA,   CHARGE_CURRENT_125_00_MA,	CHARGE_CURRENT_150_00_MA, CHARGE_CURRENT_175_00_MA,
    CHARGE_CURRENT_200_00_MA,   CHARGE_CURRENT_225_00_MA,   CHARGE_CURRENT_250_00_MA, CHARGE_CURRENT_275_00_MA,
    CHARGE_CURRENT_300_00_MA,   CHARGE_CURRENT_325_00_MA,   CHARGE_CURRENT_350_00_MA, CHARGE_CURRENT_375_00_MA,
    CHARGE_CURRENT_400_00_MA,   CHARGE_CURRENT_425_00_MA,   CHARGE_CURRENT_450_00_MA, CHARGE_CURRENT_475_00_MA,
    CHARGE_CURRENT_500_00_MA,   CHARGE_CURRENT_525_00_MA,   CHARGE_CURRENT_550_00_MA, CHARGE_CURRENT_575_00_MA,
    CHARGE_CURRENT_600_00_MA,   CHARGE_CURRENT_625_00_MA,   CHARGE_CURRENT_650_00_MA, CHARGE_CURRENT_675_00_MA,
    CHARGE_CURRENT_700_00_MA,   CHARGE_CURRENT_725_00_MA,   CHARGE_CURRENT_750_00_MA, CHARGE_CURRENT_775_00_MA,
    CHARGE_CURRENT_800_00_MA,   CHARGE_CURRENT_825_00_MA,   CHARGE_CURRENT_850_00_MA, CHARGE_CURRENT_875_00_MA,
    CHARGE_CURRENT_900_00_MA,   CHARGE_CURRENT_925_00_MA,   CHARGE_CURRENT_950_00_MA, CHARGE_CURRENT_975_00_MA,
    CHARGE_CURRENT_1000_00_MA,   CHARGE_CURRENT_1025_00_MA,   CHARGE_CURRENT_1050_00_MA, CHARGE_CURRENT_1075_00_MA,    
    CHARGE_CURRENT_1100_00_MA,   CHARGE_CURRENT_1125_00_MA,   CHARGE_CURRENT_1150_00_MA, CHARGE_CURRENT_1175_00_MA,    
    CHARGE_CURRENT_1200_00_MA,   CHARGE_CURRENT_1225_00_MA,   CHARGE_CURRENT_1250_00_MA, CHARGE_CURRENT_1275_00_MA,    
    CHARGE_CURRENT_1300_00_MA,   CHARGE_CURRENT_1325_00_MA,   CHARGE_CURRENT_1350_00_MA, CHARGE_CURRENT_1375_00_MA,    
    CHARGE_CURRENT_1400_00_MA,   CHARGE_CURRENT_1425_00_MA,   CHARGE_CURRENT_1450_00_MA, CHARGE_CURRENT_1475_00_MA,    
    CHARGE_CURRENT_1500_00_MA,   CHARGE_CURRENT_1525_00_MA,   CHARGE_CURRENT_1550_00_MA, CHARGE_CURRENT_1575_00_MA,    
    CHARGE_CURRENT_1600_00_MA,    
}; 
//VBUSLIMIT
 const unsigned int INPUT_CS_VTH[]=
 {
	 CHARGE_CURRENT_100_00_MA,	 CHARGE_CURRENT_500_00_MA,	 CHARGE_CURRENT_700_00_MA, CHARGE_CURRENT_800_00_MA,
...
extern void charger_en_gpio_output( int level);
 static unsigned int charging_hw_init(void *data)
 {
	...
	sm5701_chg_reg_config_interface(0x0D,0x1f); // VBATREG = 4.4000V
#else
	//sm5701_chg_reg_config_interface(0x0D,0x1A); // VBATREG = 4.3375V
	sm5701_chg_reg_config_interface(0x0D,0x1B); // VBATREG = 4.3500V
#endif	
#else
	sm5701_chg_reg_config_interface(0x0D,0x13); // VBATREG = 4.2V
#endif

    sm5701_chg_reg_config_interface(0x03,0xFF); // INTMSK1 = All MASK
    sm5701_chg_reg_config_interface(0x04,0xFF); // INTMSK2 = All MASK
    sm5701_chg_reg_config_interface(0x05,0xFF); // INTMSK3 = All MASK

    //sm5701_chg_set_aiclen(0); // AICL Disable
    sm5701_chg_set_aiclen(1); // AICL enable
    sm5701_chg_set_aiclth(0);	     //   4.3V
    sm5701_chg_set_autostop(0); //AUTOSTOP Disable
    
	if (mt_usb_is_device()) {
		//sm5701_chg_set_otg_en(0);
		sm5701_charger_notification(1);
	}
	if ( !charging_init_flag ) {   
		//sm5701_chg_reg_config_interface(0x04,0x1A); //146mA
		sm5701_chg_set_topoff(2); // TOPOFF : 150mA
 ...
 static unsigned int charging_set_cv_voltage(void *data)
 {
	...
	sm5701_chg_set_batreg(register_value); 
 ...
 static unsigned int charging_get_current(void *data)
 {
    ...
    sm5701_chg_read_interface(0xC, &reg_value, 0x3F, 0x0);	//FASTCHG
 ...
 static unsigned int charging_set_current(void *data)
 {
	...
	{
		//sm5701_chg_set_io_level(1);
        sm5701_chg_set_fastchg(10); // FASTCHG : 350mA
	}
	else
	{
		//sm5701_chg_set_io_level(0);
		array_size = GETARRAYNUM(CS_VTH);
		set_chr_current = bmt_find_closest_level(CS_VTH, array_size, current_value);
		register_value = charging_parameter_to_value(CS_VTH, array_size ,set_chr_current);
		sm5701_chg_set_fastchg(register_value);
	}
	return status;
 } 	
 ...
 static unsigned int charging_set_input_current(void *data)
 {
    ...
    printk("sm5701 charging_set_input_current = %d, data = %d\n",register_value,*(unsigned int *)data);
    sm5701_chg_set_vbuslimit(register_value);
 ...
 static unsigned int charging_get_charging_status(void *data)
 {
	...
	ret_val = sm5701_chg_get_topoff_status();//Topoff : Fullcharging
