...
//			LOG_INF("GC2355 analogic gain 2.02x , GC2355 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_4<= iReg)&&(iReg < ANALOG_GAIN_5))
	{
		...
		write_cmos_sensor(0xb1, temp>>6);
		write_cmos_sensor(0xb2, (temp<<2)&0xfc);
		//LOG_INF("GC5005MIPI analogic gain 2.625x , GC5005MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_5<= iReg)&&(iReg < ANALOG_GAIN_6))
	{
		...
		write_cmos_sensor(0xb1, temp>>6);
		write_cmos_sensor(0xb2, (temp<<2)&0xfc);
		//LOG_INF("GC5005MIPI analogic gain 3.734x , GC5005MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_6<= iReg)&&(iReg < ANALOG_GAIN_7))
	{
		...
		write_cmos_sensor(0xb1, temp>>6);
		write_cmos_sensor(0xb2, (temp<<2)&0xfc);
		//LOG_INF("GC5005MIPI analogic gain 5.250x , GC5005MIPI add pregain = %d\n",temp);
	}
...
/*SYS*/
	...
	write_cmos_sensor(0xf8, 0x0f); //0x11 mode-1112
	...
	write_cmos_sensor(0x17, 0x55);//Don't Change Here!!! //chg-1110                                                                                
	...
	write_cmos_sensor(0x94, 0x04);//Don't Change Here!!!   //chg-1110                                                                                                   
	...
	write_cmos_sensor(0x15, 0x00); // 0x00
	...
	write_cmos_sensor(0x1b, 0x14);//add
