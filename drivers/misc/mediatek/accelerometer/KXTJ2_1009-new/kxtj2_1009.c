...
static struct acc_hw kxtj_accel_cust = {
    ...
    .direction = 6,  //3      
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F2) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F2P)
    .direction = 4,   
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F5) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5B) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F5C)
    .direction = 3,    
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F1) || defined(LYCONFIG_AUTO_PLATFORM_NAME_F1C)
    .direction = 2,  
#elif defined(LYCONFIG_AUTO_PLATFORM_NAME_F300C)
    .direction = 0,  
#else 
    .direction = 3,
#endif
