...
#ifndef MT6572
extern void mt65xx_eint_set_hw_debounce(unsigned char eintno, unsigned int ms);
extern unsigned int mt65xx_eint_set_sens(unsigned char eintno, bool sens);
extern void mt65xx_eint_registration(unsigned char eintno, bool Dbounce_En, bool ACT_Polarity, void (EINT_FUNC_PTR) (void), bool auto_umask);
#endif

#define GTP_DRIVER_NAME  "gt91xx"
...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
   ...
   s32 gesture_idx = 0;
#endif
//	printk("zhangchongyong tpd_i2c_probe\n");
...
{
	//printk("zhangchongyong tpd_local_init\n");
#ifdef TPD_POWER_SOURCE_CUSTOM
#ifdef GTP_CONFIG_OF
#ifdef CONFIG_ARCH_MT6580
